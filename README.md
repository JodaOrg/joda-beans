...
### Releases
[Release 1.4](http://www.joda.org/joda-beans/download.html) is the current release.
...
Available in the [Maven Central repository](http://search.maven.org/#artifactdetails|org.joda|joda-beans|1.4|jar)
