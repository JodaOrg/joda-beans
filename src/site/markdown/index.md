...
[Release 1.14](download.html) is the current release.
...
Available in [Maven Central](http://search.maven.org/#artifactdetails%7Corg.joda%7Cjoda-beans%7C1.14%7Cjar).
