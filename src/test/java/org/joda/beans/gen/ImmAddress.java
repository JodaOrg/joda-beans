...
public final class ImmAddress implements ImmutableBean {
    ...
    /**
     * The array in map field.
     */
    @PropertyDefinition(validate = "notNull")
    private final ImmutableMap<String, String[]> arraysInMap;
    ...
    private ImmAddress(
            ...
            String city,
            ImmPerson owner,
            Map<String, String[]> arraysInMap) {
        JodaBeanUtils.notNull(street, "street");
        JodaBeanUtils.notNull(city, "city");
        JodaBeanUtils.notNull(owner, "owner");
        JodaBeanUtils.notNull(arraysInMap, "arraysInMap");
        this.number = number;
        this.street = street;
        this.city = city;
        this.owner = owner;
        this.arraysInMap = ImmutableMap.copyOf(arraysInMap);
    }
    ...
    //-----------------------------------------------------------------------
    /**
     * Gets the array in map field.
     * @return the value of the property, not null
     */
    public ImmutableMap<String, String[]> getArraysInMap() {
        return arraysInMap;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && obj.getClass() == this.getClass()) {
            ...
            return (getNumber() == other.getNumber()) &&
                    ...
                    JodaBeanUtils.equal(getArraysInMap(), other.getArraysInMap());
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        hash += hash * 31 + JodaBeanUtils.hashCode(getArraysInMap());
        return hash;
    }
    ...
    public String toString() {
        ...
        buf.append("arraysInMap").append('=').append(getArraysInMap());
        buf.append('}');
        return buf.toString();
    }
    ...
    public static final class Meta extends DirectMetaBean {
        ...
        /**
         * The meta-property for the {@code arraysInMap} property.
         */
        @SuppressWarnings({"unchecked", "rawtypes" })
        private final MetaProperty<ImmutableMap<String, String[]>> arraysInMap = DirectMetaProperty.ofImmutable(
                this, "arraysInMap", ImmAddress.class, (Class) ImmutableMap.class);
        /**
         * The meta-properties.
         */
         ...
         * @return the meta-property, not null
         */
        public MetaProperty<ImmutableMap<String, String[]>> arraysInMap() {
            return arraysInMap;
        }
        ...
        protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
            switch (propertyName.hashCode()) {
                ...
                case 1601092829:  // arraysInMap
                    return ((ImmAddress) bean).getArraysInMap();
            }
    ...
    public static final class Builder extends BasicImmutableBeanBuilder<ImmAddress> {
        ...
        private Map<String, String[]> arraysInMap = new HashMap<String, String[]>();
        ...
        private Builder(ImmAddress beanToCopy) {
            ...
            this.arraysInMap = new HashMap<String, String[]>(beanToCopy.getArraysInMap());
        }
        ...
        public Builder set(String propertyName, Object newValue) {
            switch (propertyName.hashCode()) {
                ...
                case 106164915:  // owner
                    ...
                    break;
                case 1601092829:  // arraysInMap
                    this.arraysInMap = (Map<String, String[]>) newValue;
                    break;
                default:
        ...
        /**
         * Sets the {@code arraysInMap} property in the builder.
         * @param arraysInMap  the new value, not null
         * @return this, for chaining, not null
         */
        public Builder arraysInMap(Map<String, String[]> arraysInMap) {
            JodaBeanUtils.notNull(arraysInMap, "arraysInMap");
            this.arraysInMap = arraysInMap;
            return this;
        }
        ...
        public String toString() {
            ...
            buf.append("arraysInMap").append('=').append(arraysInMap);
            buf.append('}');
            return buf.toString();
        }
