...
public final class ImmPerson implements ImmutableBean {
    ...
    private ImmPerson(
            ...
            Address mainAddress,
            FlexiBean extensions) {
        this.forename = forename;
        this.surname = surname;
        this.numberOfCars = numberOfCars;
        this.addressList = ImmutableList.copyOf(addressList);
        this.otherAddressMap = Collections.unmodifiableMap(new HashMap<String, Address>(otherAddressMap));
        this.addressesList = Collections.unmodifiableList(new ArrayList<List<Address>>(addressesList));
        this.mainAddress = JodaBeanUtils.clone(mainAddress);
        this.extensions = new FlexiBean(extensions);
    }
    ...
    public static class Meta extends DirectMetaBean {
        ...
        private final MetaProperty<List<Address>> addressList = DirectMetaProperty.ofReadOnly(
                this, "addressList", ImmPerson.class, (Class) List.class);
        /**
         ...
         */
        private final MetaProperty<FlexiBean> extensions = DirectMetaProperty.ofReadOnly(
                this, "extensions", ImmPerson.class, FlexiBean.class);
        /**
         * The meta-properties.
         */
        ...
        protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
            switch (propertyName.hashCode()) {
                ...
                case -1809421292:  // extensions
                    return ((ImmPerson) bean).getExtensions();
            }
    ...
    public static class Builder extends BasicImmutableBeanBuilder<ImmPerson> {
        ...
        public Builder set(String propertyName, Object newValue) {
            switch (propertyName.hashCode()) {
                ...
                case -2032731141:  // mainAddress
                    ...
                    break;
                case -1809421292:  // extensions
                    this.extensions = (FlexiBean) newValue;
                    break;
                default:
        ...
        public Builder extensions(FlexiBean newValue) {
