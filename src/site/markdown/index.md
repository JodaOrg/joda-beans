...
[Release 1.10.1](download.html) is the current release.
...
Available in [Maven Central](http://search.maven.org/#artifactdetails%7Corg.joda%7Cjoda-beans%7C1.10.1%7Cjar).
