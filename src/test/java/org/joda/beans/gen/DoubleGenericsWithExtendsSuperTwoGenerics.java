...
public class DoubleGenericsWithExtendsSuperTwoGenerics<T extends Serializable, U extends Number>
    ...
    static {
        JodaBeanUtils.registerMetaBean(DoubleGenericsWithExtendsSuperTwoGenerics.Meta.INSTANCE);
    }
    ...
    public DoubleGenericsWithExtendsSuperTwoGenerics<T, U> clone() {
        return (DoubleGenericsWithExtendsSuperTwoGenerics<T, U>) super.clone();
    }
